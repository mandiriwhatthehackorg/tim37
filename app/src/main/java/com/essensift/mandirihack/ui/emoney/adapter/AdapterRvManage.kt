...
class AdapterRvManage(
    private val items: ArrayList<Emoney>,
    val context: Context
) : RecyclerView.Adapter<AdapterRvManage.AdapterViewHolder>() {
